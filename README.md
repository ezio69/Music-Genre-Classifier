...
![neural network based classifier](https://github.com/ezio69/Music-Genre-Classifier/blob/master/neural_network_cm.png)*Neural Network based classifier*             ![SVM](https://github.com/ezio69/Music-Genre-Classifier/blob/master/svm_cm.png)*SVM*
